...
alias ls='exa --header --group-directories-first --long'
...
alias la="exa --header -a --group-directories-first --long"
alias second="cd /mnt/storage2"
alias orfani="sudo pacman -Qtdq"
alias ASE="cd /mnt/storage2/ASE"
alias Comics="cd /mnt/storage2/Comics"
